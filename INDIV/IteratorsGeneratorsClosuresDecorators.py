...
"""
Задание:
Напишите генератор, который будет выводить числа от 1 до 5, по одному числу за раз.
"""
...
и возвращает другую функцию, которая будет прибавлять это число к любому другому числу.
"""
